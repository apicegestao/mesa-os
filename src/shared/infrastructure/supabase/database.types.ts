  ...
  public: {
    Tables: {
      ...
      tutoria_member_memories: {
        Row: { confidence: number; content: string; created_at: string; created_by: string; id: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id: string; source_cycle_id: string | null; source_evidence_id: string | null; source_execution_id: string | null; source_implementation_id: string | null; source_kind: string; source_mission_id: string | null; source_priority_id: string | null; state: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; updated_at: string; updated_by: string; valid_from: string; valid_until: string | null; version: number }
        Insert: { confidence?: number; content: string; created_at?: string; created_by: string; id?: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id: string; source_cycle_id?: string | null; source_evidence_id?: string | null; source_execution_id?: string | null; source_implementation_id?: string | null; source_kind?: string; source_mission_id?: string | null; state?: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; updated_at?: string; updated_by: string; valid_from?: string; valid_until?: string | null; version?: number }
        Update: { confidence?: number; content?: string; created_at?: string; created_by?: string; id?: string; kind?: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id?: string; source_cycle_id?: string | null; source_evidence_id?: string | null; source_execution_id?: string | null; source_implementation_id?: string | null; source_kind?: string; source_mission_id?: string | null; state?: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id?: string; updated_at?: string; updated_by?: string; valid_from?: string; valid_until?: string | null; version?: number }
        Relationships: []
      }
      tutoria_member_memory_revisions: {
        Row: { change_kind: string; changed_by: string; confidence: number; content: string; created_at: string; id: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; memory_id: string; organization_id: string; source_evidence_id: string | null; source_execution_id: string | null; source_implementation_id: string | null; source_mission_id: string | null; state: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; valid_until: string | null; version: number }
      ...
      tutoria_workbench_analysis_audits: {
        Row: { actor_identity_id: string; created_at: string; duration_ms: number; failure_code: string | null; id: string; model_code: string | null; organization_id: string; outcome: Database["public"]["Enums"]["tutoria_workbench_analysis_outcome"]; provider_code: string; response_schema_valid: boolean; tool_code: string }
        Insert: { actor_identity_id: string; created_at?: string; duration_ms?: number; failure_code?: string | null; id?: string; model_code?: string | null; organization_id: string; outcome: Database["public"]["Enums"]["tutoria_workbench_analysis_outcome"]; provider_code: string; response_schema_valid?: boolean; tool_code: string }
        Update: { actor_identity_id?: string; created_at?: string; duration_ms?: number; failure_code?: string | null; id?: string; model_code?: string | null; organization_id?: string; outcome?: Database["public"]["Enums"]["tutoria_workbench_analysis_outcome"]; provider_code?: string; response_schema_valid?: boolean; tool_code?: string }
        Relationships: []
      }
    ...
    Enums: {
      ...
      tutoria_tool_name: "read_member_state" | "read_methodology_map" | "read_workbench_tool" | "read_longitudinal_context"
      tutoria_workbench_analysis_outcome: "served" | "unavailable" | "escalated"
