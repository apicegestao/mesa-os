  ...
  public: {
    Tables: {
      ...
      tutoria_member_memories: {
        Row: { confidence: number; content: string; created_at: string; created_by: string; id: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id: string; source_execution_id: string | null; source_kind: string; state: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; updated_at: string; updated_by: string; valid_from: string; valid_until: string | null; version: number }
        Insert: { confidence?: number; content: string; created_at?: string; created_by: string; id?: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id: string; source_execution_id?: string | null; source_kind?: string; state?: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; updated_at?: string; updated_by: string; valid_from?: string; valid_until?: string | null; version?: number }
        Update: { confidence?: number; content?: string; created_at?: string; created_by?: string; id?: string; kind?: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id?: string; source_execution_id?: string | null; source_kind?: string; state?: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id?: string; updated_at?: string; updated_by?: string; valid_from?: string; valid_until?: string | null; version?: number }
        Relationships: []
      }
      tutoria_member_memory_revisions: {
        Row: { change_kind: string; changed_by: string; confidence: number; content: string; created_at: string; id: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; memory_id: string; organization_id: string; source_execution_id: string | null; state: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; valid_until: string | null; version: number }
