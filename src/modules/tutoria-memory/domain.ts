...
export type TutorIAMemory = { id: string; kind: (typeof memoryKinds)[number]; content: string; sourceKind: "member_confirmed" | "diagnostic_completed"; confidence: number; state: "active" | "contested" | "superseded" | "expired"; validUntil: string | null; version: number; updatedAt: string };
