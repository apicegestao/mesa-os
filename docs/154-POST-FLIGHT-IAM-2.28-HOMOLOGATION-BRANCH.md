...
1. O deploy preview foi apontado para a branch isolada via variáveis públicas do Netlify; a flag de código permaneceu desligada (`false`). O rebuild do PR #13 concluiu com êxito e secret scan sem ocorrências.
