  ...
  public: {
    Tables: {
      ...
      tutoria_member_memories: {
        Row: { confidence: number; content: string; created_at: string; created_by: string; id: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id: string; source_cycle_id: string | null; source_execution_id: string | null; source_kind: string; state: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; updated_at: string; updated_by: string; valid_from: string; valid_until: string | null; version: number }
        Insert: { confidence?: number; content: string; created_at?: string; created_by: string; id?: string; kind: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id: string; source_cycle_id?: string | null; source_execution_id?: string | null; source_kind?: string; state?: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id: string; updated_at?: string; updated_by: string; valid_from?: string; valid_until?: string | null; version?: number }
        Update: { confidence?: number; content?: string; created_at?: string; created_by?: string; id?: string; kind?: Database["public"]["Enums"]["tutoria_memory_kind"]; organization_id?: string; source_cycle_id?: string | null; source_execution_id?: string | null; source_kind?: string; state?: Database["public"]["Enums"]["tutoria_memory_state"]; subject_identity_id?: string; updated_at?: string; updated_by?: string; valid_from?: string; valid_until?: string | null; version?: number }
        Relationships: []
      }
